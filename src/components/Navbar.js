...
export default class Navbar extends Component {
  ...
  render() {
    ...
    <a className="navbar-brand" href="#">
      <img src="https://thumbnails.yayimages.com/1600/b/3ac/b3ac7fe.jpg" alt="" width="30" height="30" style={{borderRadius: '10px'}}/>
    </a>
          ...
          <ul className="dropdown-menu">
            ...
            <li><a className="dropdown-item" href="/">United Stated</a></li>
